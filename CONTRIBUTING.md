...
issue](https://github.com/cisagov/OSINF_Toolkit/issues) in
...
request](https://github.com/cisagov/OSINF_Toolkit/pulls),
...
```console
cd OSINF_Toolkit
pyenv virtualenv <python_version_to_use> OSINF_Toolkit
pyenv local OSINF_Toolkit
